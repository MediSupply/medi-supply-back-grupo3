...
class TestConfig:
    ...
    def test_create_app(self, mock_cliente_routes, mock_provedores_routes, mock_producto_routes, mock_auth_routes, mock_health_routes, mock_db, mock_init_db):
        """Test de create_app"""
        from config.config import Config
    ...
    def test_setup_dependencies(self, mock_auth_cmd, mock_auth_use_case, mock_auth_service, mock_auth_repo, mock_health_cmd, mock_health_use_case, mock_health_service, mock_health_repo, mock_db, mock_init_db):
    ...
    @patch("config.config.create_provedores_routes")
    @patch("config.config.create_cliente_routes")
    def test_register_routes(self, mock_cliente_routes, mock_provedores_routes, mock_producto_routes, mock_auth_routes, mock_health_routes, mock_db, mock_init_db):
    ...
    @patch("config.config.create_provedores_routes")
    @patch("config.config.create_cliente_routes")
    def test_root_route(self, mock_cliente_routes, mock_provedores_routes, mock_producto_routes, mock_auth_routes, mock_health_routes, mock_db, mock_init_db):

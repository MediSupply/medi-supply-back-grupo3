...
class TestConfig:
    ...
    def test_create_app(self, mock_auth_cmd, mock_auth_service, mock_create_auth_routes,
                       mock_create_producto_routes, mock_create_auth_module,
                       mock_create_auth_middleware, mock_db, mock_init_db,
                       mock_load_dotenv):
    ...
    @patch('src.modules.autorizador.aplicacion.servicios.auth_service.AuthService')
    @patch('src.modules.autorizador.infraestructura.cmd.auth_cmd.AuthCmd')
    def test_create_app_with_defaults(self, mock_auth_cmd, mock_auth_service, mock_create_auth_routes,
                                     mock_create_producto_routes, mock_create_auth_module,
                                     mock_create_auth_middleware, mock_db, mock_init_db,
                                     mock_load_dotenv):
    ...
    @patch('src.modules.autorizador.aplicacion.servicios.auth_service.AuthService')
    @patch('src.modules.autorizador.infraestructura.cmd.auth_cmd.AuthCmd')
    def test_get_app(self, mock_auth_cmd, mock_auth_service, mock_create_auth_routes,
                    mock_create_producto_routes, mock_create_auth_module,
                    mock_create_auth_middleware, mock_db, mock_init_db,
                    mock_load_dotenv):
        """Test de get_app"""
    ...
    @patch('src.modules.autorizador.aplicacion.servicios.auth_service.AuthService')
    @patch('src.modules.autorizador.infraestructura.cmd.auth_cmd.AuthCmd')
    def test_configure_app(self, mock_auth_cmd, mock_auth_service, mock_create_auth_routes,
                          mock_create_producto_routes, mock_create_auth_module,
                          mock_create_auth_middleware, mock_db, mock_init_db,
                          mock_load_dotenv):
    ...
    def test_configure_cors(self, mock_cors, mock_auth_cmd, mock_auth_service, mock_create_auth_routes,
                           mock_create_producto_routes, mock_create_auth_module,
                           mock_create_auth_middleware, mock_db, mock_init_db,
                           mock_load_dotenv):
    ...
    @patch('src.modules.autorizador.aplicacion.servicios.auth_service.AuthService')
    @patch('src.modules.autorizador.infraestructura.cmd.auth_cmd.AuthCmd')
    def test_configure_db(self, mock_auth_cmd, mock_auth_service, mock_create_auth_routes,
                         mock_create_producto_routes, mock_create_auth_module,
                         mock_create_auth_middleware, mock_db, mock_init_db,
                         mock_load_dotenv):
    ...
    @patch('src.modules.autorizador.aplicacion.servicios.auth_service.AuthService')
    @patch('src.modules.autorizador.infraestructura.cmd.auth_cmd.AuthCmd')
    def test_register_routes(self, mock_auth_cmd, mock_auth_service, mock_create_auth_routes,
                            mock_create_producto_routes, mock_create_auth_module,
                            mock_create_auth_middleware, mock_db, mock_init_db,
                            mock_load_dotenv):
    ...
    @patch('src.modules.autorizador.aplicacion.servicios.auth_service.AuthService')
    @patch('src.modules.autorizador.infraestructura.cmd.auth_cmd.AuthCmd')
    def test_root_route(self, mock_auth_cmd, mock_auth_service, mock_create_auth_routes,
                       mock_create_producto_routes, mock_create_auth_module,
                       mock_create_auth_middleware, mock_db, mock_init_db,
                       mock_load_dotenv):
        """Test de ruta raíz /"""
    ...
    @patch('src.modules.autorizador.aplicacion.servicios.auth_service.AuthService')
    @patch('src.modules.autorizador.infraestructura.cmd.auth_cmd.AuthCmd')
    def test_health_route(self, mock_auth_cmd, mock_auth_service, mock_create_auth_routes,
                         mock_create_producto_routes, mock_create_auth_module,
                         mock_create_auth_middleware, mock_db, mock_init_db,
                         mock_load_dotenv):
        """Test de ruta /health"""
    ...
    @patch('src.modules.autorizador.aplicacion.servicios.auth_service.AuthService')
    @patch('src.modules.autorizador.infraestructura.cmd.auth_cmd.AuthCmd')
    def test_request_logging(self, mock_auth_cmd, mock_auth_service, mock_create_auth_routes,
                            mock_create_producto_routes, mock_create_auth_module,
                            mock_create_auth_middleware, mock_db, mock_init_db,
                            mock_load_dotenv):
    ...
    @patch('src.modules.autorizador.aplicacion.servicios.auth_service.AuthService')
    @patch('src.modules.autorizador.infraestructura.cmd.auth_cmd.AuthCmd')
    def test_request_logging_with_json_body(self, mock_auth_cmd, mock_auth_service, mock_create_auth_routes,
                                           mock_create_producto_routes, mock_create_auth_module,
                                           mock_create_auth_middleware, mock_db, mock_init_db,
                                           mock_load_dotenv):
    ...
    @patch('src.modules.autorizador.aplicacion.servicios.auth_service.AuthService')
    @patch('src.modules.autorizador.infraestructura.cmd.auth_cmd.AuthCmd')
    def test_response_logging_without_start_time(self, mock_auth_cmd, mock_auth_service, mock_create_auth_routes,
                                                 mock_create_producto_routes, mock_create_auth_module,
                                                 mock_create_auth_middleware, mock_db, mock_init_db,
                                                 mock_load_dotenv):
    ...
    @patch('src.modules.autorizador.aplicacion.servicios.auth_service.AuthService')
    @patch('src.modules.autorizador.infraestructura.cmd.auth_cmd.AuthCmd')
    def test_setup_dependencies(self, mock_auth_cmd, mock_auth_service, mock_create_auth_routes,
                               mock_create_producto_routes, mock_create_auth_module,
                               mock_create_auth_middleware, mock_db, mock_init_db,
                               mock_load_dotenv):

...
class ProductoCmd:
    ...
    def obtener_todos_los_productos(self):
        ...
        try:
            ...
            return jsonify({"success": True, "data": productos_json, "total": len(productos_json)}), 200
    ...
    def obtener_producto_por_id(self, producto_id: str):
        ...
        try:
            ...
            return jsonify({"success": True, "data": producto_json}), 200
        except Exception as e:
            return jsonify({"success": False, "error": str(e)}), 500
    ...
    def obtener_productos_por_categoria(self, categoria: str):
        ...
        try:
            ...
            return (
                jsonify({"success": True, "data": productos_json, "total": len(productos_json), "categoria": categoria}),
                200,
            )
        except Exception as e:
            return jsonify({"success": False, "error": str(e)}), 500
    ...
    def buscar_productos_por_nombre(self, nombre: str):
        ...
        try:
            ...
            return jsonify({"success": True, "data": productos_json, "total": len(productos_json), "busqueda": nombre}), 200
        except Exception as e:
            return jsonify({"success": False, "error": str(e)}), 500

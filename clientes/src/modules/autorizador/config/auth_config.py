...
class AuthConfig:
    ...
    ROLE_PERMISSIONS = {
        ...
        Role.MANAGER: {
            ...
            ResourceType.CLIENTS: [ActionType.CREATE, ActionType.READ, ActionType.UPDATE, ActionType.DELETE],
            ResourceType.USERS: [ActionType.READ],
            ResourceType.HEALTH: [ActionType.READ],
        },
        Role.USER: {ResourceType.PRODUCTS: [ActionType.READ], ResourceType.PROVIDERS: [ActionType.READ], ResourceType.CLIENTS: [ActionType.READ, ActionType.CREATE, ActionType.UPDATE, ActionType.DELETE]},
        Role.VIEWER: {
            ResourceType.PRODUCTS: [ActionType.READ],
            ResourceType.CLIENTS: [ActionType.READ],
...
class RouteConfig:
    ...
    RATE_LIMITED_ROUTES = {
        ...
        "/clientes/buscar": {"requests": 100, "window": 60},
    }

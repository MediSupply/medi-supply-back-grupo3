...
class AuthCmd:
    ...
    def authorize_access(self) -> Response:
        ...
        try:
            ...
            if authorized:
                ...
                return jsonify({"authorized": True, "user_info": user_info, "message": "Acceso autorizado"}), 200
            else:
                return jsonify({"authorized": False, "message": "Acceso denegado"}), 403
    ...
    def get_user_info(self) -> Response:
        ...
        try:
            ...
            if user_info:
                return jsonify({"user_info": user_info, "message": "Información obtenida exitosamente"}), 200
            else:

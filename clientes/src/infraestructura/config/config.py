...
class Config:
    ...
    def _configure_app(self):
        ...
        self.app.config["PORT"] = int(os.getenv("PORT", 5004))
        ...
        self.app.config["SQLALCHEMY_DATABASE_URI"] = os.getenv("DATABASE_URL", "sqlite:///clientes.db")
    ...
    def _setup_dependencies(self):
        ...
        cliente_repository = ClienteRepositoryImpl()
        # Capa de Dominio
        cliente_service = ClienteService(cliente_repository)
        # Capa de Aplicación
        cliente_use_case = ClienteUseCase(cliente_service)
        # Capa de Presentación (Controladores)
        self.cliente_controller = ClienteCmd(cliente_use_case)
    ...
    def _register_routes(self):
        ...
        cliente_routes = create_cliente_routes(self.cliente_controller)
        self.app.register_blueprint(cliente_routes)
        ...
        def root():
            return {
                "message": "Microservicio de Clientes is running",
                "version": "1.0.0",
                ...
                "permissions": {
                    ...
                    "USER": "Full access to clients",
                    "MANAGER": "Full access to clients",
                    "VIEWER": "Read-only access to clients",
                },
            }
        ...
        def health():
            return {"status": "healthy", "service": "clientes", "version": "1.0.0", "auth_enabled": True}

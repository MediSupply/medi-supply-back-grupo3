...
def create_application():
    ...
    try:
        ...
        logger.info("Microservicio de Clientes initialized successfully")
        return app

    except Exception as e:
        logger.error(f"Failed to initialize Microservicio de Clientes: {str(e)}")
        raise
...
if __name__ == "__main__":
    ...
    print(f"Starting Microservicio de Clientes on {host}:{port}")

...
class TestAccessValidator:
    ...
    def test_is_public_route_private(self, validator):
        ...
        assert validator._is_public_route("/clientes") is False
        assert validator._is_public_route("/clientes/123") is False
    ...
    def test_validate_access_viewer_create_denied(self, validator, viewer_payload):
        ...
        with pytest.raises(InsufficientPermissionsError):
            validator.validate_access(viewer_payload, "/clientes", "POST")
    ...
    def test_get_required_permission_exact_route(self, validator):
        ...
        resource, action = validator._get_required_permission("/clientes", "GET")
        assert resource == ResourceType.CLIENTS
    ...
    def test_get_required_permission_prefix_route(self, validator):
        ...
        resource, action = validator._get_required_permission("/clientes/123", "GET")
        assert resource == ResourceType.CLIENTS
        assert action == ActionType.READ
